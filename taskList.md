...
- [ ] CSS 的四个阶段课程讲一讲？CSS 基础略，CSS 布局和高级选择器，CSS 动画，SASS 和 bootstrap？可以考虑一下。
...
- [x] 准备录制信息科学基础习题课（课程已经上线发布，接下来就是按照教学进度上传视频就行）  
- [x] Github 开源之旅第四季：团队协作  
- [x] Githhub 开源之旅第三季：Git 进阶  
  - Git 和 Github 工具  
    - 启程，初步的介绍了一下  
    - 不知道合并是什么，不知道冲突怎么解决  
    - 不知道分支是什么  
...
- [ ] 参考阮一峰老师的中文技术文档手册制作一个 md 文档规范检查的 hint 或者 lint 工具  
